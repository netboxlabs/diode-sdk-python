"""
CircuitGroupAssignment entity examples for the Diode Python SDK.

This module demonstrates three patterns for ingesting CircuitGroupAssignment entities:
- circuit_group_assignment_minimal: Required fields only
- circuit_group_assignment_extended: Common optional fields
...
def main():
    """Main execution - demonstrates ingesting a CircuitGroupAssignment entity."""
    with DiodeClient(
        target=TARGET,
        app_name=APP_NAME,
        ...
        if response.errors:
            ...
            print("CircuitGroupAssignment ingested successfully")
...
def circuit_group_assignment_explicit() -> CircuitGroupAssignment:
