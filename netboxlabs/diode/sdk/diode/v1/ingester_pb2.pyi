...
class Entity(_message.Message):
    ...
    CABLE_BUNDLE_FIELD_NUMBER: _ClassVar[int]
    RACK_GROUP_FIELD_NUMBER: _ClassVar[int]
    SCRIPT_MODULE_FIELD_NUMBER: _ClassVar[int]
    VIRTUAL_MACHINE_TYPE_FIELD_NUMBER: _ClassVar[int]
    USER_FIELD_NUMBER: _ClassVar[int]
    COOLING_FEED_FIELD_NUMBER: _ClassVar[int]
    COOLING_INTAKE_FIELD_NUMBER: _ClassVar[int]
    COOLING_OUTFLOW_FIELD_NUMBER: _ClassVar[int]
    COOLING_SOURCE_FIELD_NUMBER: _ClassVar[int]
    MODULE_BAY_TYPE_FIELD_NUMBER: _ClassVar[int]
...
class IngestRequest(_message.Message):
    ...
    def __init__(self, stream: _Optional[str] = ..., entities: _Optional[_Iterable[_Union[Entity, _Mapping]]] = ..., id: _Optional[str] = ..., producer_app_name: _Optional[str] = ..., producer_app_version: _Optional[str] = ..., sdk_name: _Optional[str] = ..., sdk_version: _Optional[str] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...
...
class ASN(_message.Message):
    __slots__ = ("asn", "rir", "tenant", "description", "comments", "tags", "custom_fields", "metadata", "owner", "sites", "role")
...
class ASNRange(_message.Message):
    ...
    owner: Owner
    comments: str
    def __init__(self, name: _Optional[str] = ..., slug: _Optional[str] = ..., rir: _Optional[_Union[RIR, _Mapping]] = ..., start: _Optional[int] = ..., end: _Optional[int] = ..., tenant: _Optional[_Union[Tenant, _Mapping]] = ..., description: _Optional[str] = ..., tags: _Optional[_Iterable[_Union[Tag, _Mapping]]] = ..., custom_fields: _Optional[_Mapping[str, CustomFieldValue]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., owner: _Optional[_Union[Owner, _Mapping]] = ..., comments: _Optional[str] = ...) -> None: ...

class Aggregate(_message.Message):
    __slots__ = ("prefix", "rir", "tenant", "date_added", "description", "comments", "tags", "custom_fields", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class CablePath(_message.Message):
    ...
    is_split: bool
    metadata: _struct_pb2.Struct
    def __init__(self, is_active: bool = ..., is_complete: bool = ..., is_split: bool = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...

class CableTermination(_message.Message):
    __slots__ = ("cable", "cable_end", "termination_circuit_termination", "termination_console_port", "termination_console_server_port", "termination_front_port", "termination_interface", "termination_power_feed", "termination_power_outlet", "termination_power_port", "termination_rear_port", "metadata")
    CABLE_FIELD_NUMBER: _ClassVar[int]
...
class Circuit(_message.Message):
    __slots__ = ("cid", "provider", "provider_account", "type", "status", "tenant", "install_date", "termination_date", "commit_rate", "description", "distance", "distance_unit", "comments", "tags", "assignments", "custom_fields", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class CircuitGroup(_message.Message):
    __slots__ = ("name", "slug", "description", "tenant", "tags", "custom_fields", "metadata", "owner", "comments")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    owner: Owner
    comments: str
    def __init__(self, name: _Optional[str] = ..., slug: _Optional[str] = ..., description: _Optional[str] = ..., tenant: _Optional[_Union[Tenant, _Mapping]] = ..., tags: _Optional[_Iterable[_Union[Tag, _Mapping]]] = ..., custom_fields: _Optional[_Mapping[str, CustomFieldValue]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., owner: _Optional[_Union[Owner, _Mapping]] = ..., comments: _Optional[str] = ...) -> None: ...

class CircuitGroupAssignment(_message.Message):
    __slots__ = ("group", "member_circuit", "member_virtual_circuit", "priority", "tags", "metadata")
    ...
    tags: _containers.RepeatedCompositeFieldContainer[Tag]
    metadata: _struct_pb2.Struct
    def __init__(self, group: _Optional[_Union[CircuitGroup, _Mapping]] = ..., member_circuit: _Optional[_Union[Circuit, _Mapping]] = ..., member_virtual_circuit: _Optional[_Union[VirtualCircuit, _Mapping]] = ..., priority: _Optional[str] = ..., tags: _Optional[_Iterable[_Union[Tag, _Mapping]]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...

class CircuitTermination(_message.Message):
    __slots__ = ("circuit", "term_side", "termination_location", "termination_provider_network", "termination_region", "termination_site", "termination_site_group", "port_speed", "upstream_speed", "xconnect_id", "pp_info", "description", "mark_connected", "tags", "custom_fields", "metadata")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class CircuitType(_message.Message):
    __slots__ = ("name", "slug", "color", "description", "tags", "custom_fields", "metadata", "owner", "comments")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    owner: Owner
    comments: str
    def __init__(self, name: _Optional[str] = ..., slug: _Optional[str] = ..., color: _Optional[str] = ..., description: _Optional[str] = ..., tags: _Optional[_Iterable[_Union[Tag, _Mapping]]] = ..., custom_fields: _Optional[_Mapping[str, CustomFieldValue]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., owner: _Optional[_Union[Owner, _Mapping]] = ..., comments: _Optional[str] = ...) -> None: ...

class Cluster(_message.Message):
    __slots__ = ("name", "type", "group", "status", "tenant", "scope_location", "scope_region", "scope_site", "scope_site_group", "description", "comments", "tags", "custom_fields", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class ClusterGroup(_message.Message):
    __slots__ = ("name", "slug", "description", "tags", "custom_fields", "metadata", "owner", "comments")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    owner: Owner
    comments: str
    def __init__(self, name: _Optional[str] = ..., slug: _Optional[str] = ..., description: _Optional[str] = ..., tags: _Optional[_Iterable[_Union[Tag, _Mapping]]] = ..., custom_fields: _Optional[_Mapping[str, CustomFieldValue]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., owner: _Optional[_Union[Owner, _Mapping]] = ..., comments: _Optional[str] = ...) -> None: ...
...
class ConsolePort(_message.Message):
    __slots__ = ("device", "module", "name", "label", "type", "speed", "description", "mark_connected", "tags", "custom_fields", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class Contact(_message.Message):
    __slots__ = ("group", "name", "title", "phone", "email", "address", "link", "description", "comments", "tags", "custom_fields", "groups", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class ContactAssignment(_message.Message):
    ...
    OBJECT_OWNER_FIELD_NUMBER: _ClassVar[int]
    OBJECT_OWNER_GROUP_FIELD_NUMBER: _ClassVar[int]
    OBJECT_CABLE_BUNDLE_FIELD_NUMBER: _ClassVar[int]
    OBJECT_RACK_GROUP_FIELD_NUMBER: _ClassVar[int]
    OBJECT_SCRIPT_MODULE_FIELD_NUMBER: _ClassVar[int]
    OBJECT_VIRTUAL_MACHINE_TYPE_FIELD_NUMBER: _ClassVar[int]
    OBJECT_USER_FIELD_NUMBER: _ClassVar[int]
    OBJECT_COOLING_FEED_FIELD_NUMBER: _ClassVar[int]
    OBJECT_COOLING_INTAKE_FIELD_NUMBER: _ClassVar[int]
    OBJECT_COOLING_OUTFLOW_FIELD_NUMBER: _ClassVar[int]
    OBJECT_COOLING_SOURCE_FIELD_NUMBER: _ClassVar[int]
    OBJECT_MODULE_BAY_TYPE_FIELD_NUMBER: _ClassVar[int]
    CONTACT_FIELD_NUMBER: _ClassVar[int]
    ROLE_FIELD_NUMBER: _ClassVar[int]
    PRIORITY_FIELD_NUMBER: _ClassVar[int]
    TAGS_FIELD_NUMBER: _ClassVar[int]
    ...
    object_owner: Owner
    object_owner_group: OwnerGroup
    object_cable_bundle: CableBundle
    object_rack_group: RackGroup
    object_script_module: ScriptModule
    object_virtual_machine_type: VirtualMachineType
    object_user: User
    object_cooling_feed: CoolingFeed
    object_cooling_intake: CoolingIntake
    object_cooling_outflow: CoolingOutflow
    object_cooling_source: CoolingSource
    object_module_bay_type: ModuleBayType
    contact: Contact
    role: ContactRole
    priority: str
    tags: _containers.RepeatedCompositeFieldContainer[Tag]
...
class CustomFieldObjectReference(_message.Message):
    __slots__ = ("asn", "asn_range", "aggregate", "cable", "cable_path", "cable_termination", "circuit", "circuit_group", "circuit_group_assignment", "circuit_termination", "circuit_type", "cluster", "cluster_group", "cluster_type", "console_port", "console_server_port", "contact", "contact_assignment", "contact_group", "contact_role", "device", "device_bay", "device_role", "device_type", "fhrp_group", "fhrp_group_assignment", "front_port", "ike_policy", "ike_proposal", "ip_address", "ip_range", "ip_sec_policy", "ip_sec_profile", "ip_sec_proposal", "interface", "inventory_item", "inventory_item_role", "l2vpn", "l2vpn_termination", "location", "mac_address", "manufacturer", "module", "module_bay", "module_type", "platform", "power_feed", "power_outlet", "power_panel", "power_port", "prefix", "provider", "provider_account", "provider_network", "rir", "rack", "rack_reservation", "rack_role", "rack_type", "rear_port", "region", "role", "route_target", "service", "site", "site_group", "tag", "tenant", "tenant_group", "tunnel", "tunnel_group", "tunnel_termination", "vlan", "vlan_group", "vlan_translation_policy", "vlan_translation_rule", "vm_interface", "vrf", "virtual_chassis", "virtual_circuit", "virtual_circuit_termination", "virtual_circuit_type", "virtual_device_context", "virtual_disk", "virtual_machine", "wireless_lan", "wireless_lan_group", "wireless_link", "custom_field", "custom_field_choice_set", "journal_entry", "module_type_profile", "custom_link", "owner", "owner_group", "cable_bundle", "rack_group", "script_module", "virtual_machine_type", "user", "cooling_feed", "cooling_intake", "cooling_outflow", "cooling_source", "module_bay_type")
    ASN_FIELD_NUMBER: _ClassVar[int]
    ASN_RANGE_FIELD_NUMBER: _ClassVar[int]
    AGGREGATE_FIELD_NUMBER: _ClassVar[int]
    CABLE_FIELD_NUMBER: _ClassVar[int]
...
class Device(_message.Message):
    __slots__ = ("name", "device_type", "role", "tenant", "platform", "serial", "asset_tag", "site", "location", "rack", "position", "face", "latitude", "longitude", "status", "airflow", "primary_ip4", "primary_ip6", "oob_ip", "cluster", "virtual_chassis", "vc_position", "vc_priority", "description", "comments", "tags", "custom_fields", "metadata", "owner", "config", "cooling_method")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    COOLING_METHOD_FIELD_NUMBER: _ClassVar[int]
    name: str
    device_type: DeviceType
    role: DeviceRole
    tenant: Tenant
...
class DeviceType(_message.Message):
    __slots__ = ("manufacturer", "default_platform", "model", "slug", "part_number", "u_height", "exclude_from_utilization", "is_full_depth", "subdevice_role", "airflow", "weight", "weight_unit", "description", "comments", "tags", "custom_fields", "metadata", "owner", "cooling_method", "end_of_life")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class FHRPGroupAssignment(_message.Message):
    ...
    INTERFACE_OWNER_FIELD_NUMBER: _ClassVar[int]
    INTERFACE_OWNER_GROUP_FIELD_NUMBER: _ClassVar[int]
    INTERFACE_CABLE_BUNDLE_FIELD_NUMBER: _ClassVar[int]
    INTERFACE_RACK_GROUP_FIELD_NUMBER: _ClassVar[int]
    INTERFACE_SCRIPT_MODULE_FIELD_NUMBER: _ClassVar[int]
    INTERFACE_VIRTUAL_MACHINE_TYPE_FIELD_NUMBER: _ClassVar[int]
    INTERFACE_USER_FIELD_NUMBER: _ClassVar[int]
    INTERFACE_COOLING_FEED_FIELD_NUMBER: _ClassVar[int]
    INTERFACE_COOLING_INTAKE_FIELD_NUMBER: _ClassVar[int]
    INTERFACE_COOLING_OUTFLOW_FIELD_NUMBER: _ClassVar[int]
    INTERFACE_COOLING_SOURCE_FIELD_NUMBER: _ClassVar[int]
    INTERFACE_MODULE_BAY_TYPE_FIELD_NUMBER: _ClassVar[int]
    PRIORITY_FIELD_NUMBER: _ClassVar[int]
    METADATA_FIELD_NUMBER: _ClassVar[int]
    group: FHRPGroup
    interface_asn: ASN
...
class IKEPolicy(_message.Message):
    __slots__ = ("name", "description", "version", "mode", "preshared_key", "comments", "tags", "custom_fields", "proposals", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class IKEProposal(_message.Message):
    __slots__ = ("name", "description", "authentication_method", "encryption_algorithm", "authentication_algorithm", "group", "sa_lifetime", "comments", "tags", "custom_fields", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class IPAddress(_message.Message):
    __slots__ = ("address", "vrf", "tenant", "status", "role", "assigned_object_fhrp_group", "assigned_object_interface", "assigned_object_vm_interface", "nat_inside", "dns_name", "description", "comments", "tags", "custom_fields", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class IPRange(_message.Message):
    __slots__ = ("start_address", "end_address", "vrf", "tenant", "status", "role", "description", "comments", "tags", "mark_utilized", "custom_fields", "mark_populated", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class IPSecPolicy(_message.Message):
    __slots__ = ("name", "description", "pfs_group", "comments", "tags", "custom_fields", "proposals", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class IPSecProfile(_message.Message):
    __slots__ = ("name", "description", "mode", "ike_policy", "ipsec_policy", "comments", "tags", "custom_fields", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class IPSecProposal(_message.Message):
    __slots__ = ("name", "description", "encryption_algorithm", "authentication_algorithm", "sa_lifetime_seconds", "sa_lifetime_data", "comments", "tags", "custom_fields", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class InventoryItem(_message.Message):
    ...
    COMPONENT_COOLING_INTAKE_FIELD_NUMBER: _ClassVar[int]
    COMPONENT_COOLING_OUTFLOW_FIELD_NUMBER: _ClassVar[int]
    TAGS_FIELD_NUMBER: _ClassVar[int]
    CUSTOM_FIELDS_FIELD_NUMBER: _ClassVar[int]
    METADATA_FIELD_NUMBER: _ClassVar[int]
    OWNER_FIELD_NUMBER: _ClassVar[int]
...
class L2VPN(_message.Message):
    __slots__ = ("identifier", "name", "slug", "type", "description", "comments", "tenant", "tags", "custom_fields", "import_targets", "export_targets", "status", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class L2VPNTermination(_message.Message):
    ...
    ASSIGNED_OBJECT_OWNER_FIELD_NUMBER: _ClassVar[int]
    ASSIGNED_OBJECT_OWNER_GROUP_FIELD_NUMBER: _ClassVar[int]
    ASSIGNED_OBJECT_CABLE_BUNDLE_FIELD_NUMBER: _ClassVar[int]
    ASSIGNED_OBJECT_RACK_GROUP_FIELD_NUMBER: _ClassVar[int]
    ASSIGNED_OBJECT_SCRIPT_MODULE_FIELD_NUMBER: _ClassVar[int]
    ASSIGNED_OBJECT_VIRTUAL_MACHINE_TYPE_FIELD_NUMBER: _ClassVar[int]
    ASSIGNED_OBJECT_USER_FIELD_NUMBER: _ClassVar[int]
    ASSIGNED_OBJECT_COOLING_FEED_FIELD_NUMBER: _ClassVar[int]
    ASSIGNED_OBJECT_COOLING_INTAKE_FIELD_NUMBER: _ClassVar[int]
    ASSIGNED_OBJECT_COOLING_OUTFLOW_FIELD_NUMBER: _ClassVar[int]
    ASSIGNED_OBJECT_COOLING_SOURCE_FIELD_NUMBER: _ClassVar[int]
    ASSIGNED_OBJECT_MODULE_BAY_TYPE_FIELD_NUMBER: _ClassVar[int]
    TAGS_FIELD_NUMBER: _ClassVar[int]
    CUSTOM_FIELDS_FIELD_NUMBER: _ClassVar[int]
    METADATA_FIELD_NUMBER: _ClassVar[int]
    l2vpn: L2VPN
...
class MACAddress(_message.Message):
    __slots__ = ("mac_address", "assigned_object_interface", "assigned_object_vm_interface", "description", "comments", "tags", "custom_fields", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class Module(_message.Message):
    __slots__ = ("device", "module_bay", "module_type", "status", "serial", "asset_tag", "description", "comments", "tags", "custom_fields", "metadata", "owner", "replicate_components", "adopt_components")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    METADATA_FIELD_NUMBER: _ClassVar[int]
    OWNER_FIELD_NUMBER: _ClassVar[int]
    REPLICATE_COMPONENTS_FIELD_NUMBER: _ClassVar[int]
    ADOPT_COMPONENTS_FIELD_NUMBER: _ClassVar[int]
    device: Device
    module_bay: ModuleBay
    module_type: ModuleType
    status: str
    ...
    metadata: _struct_pb2.Struct
    owner: Owner
    replicate_components: bool
    adopt_components: bool
    def __init__(self, device: _Optional[_Union[Device, _Mapping]] = ..., module_bay: _Optional[_Union[ModuleBay, _Mapping]] = ..., module_type: _Optional[_Union[ModuleType, _Mapping]] = ..., status: _Optional[str] = ..., serial: _Optional[str] = ..., asset_tag: _Optional[str] = ..., description: _Optional[str] = ..., comments: _Optional[str] = ..., tags: _Optional[_Iterable[_Union[Tag, _Mapping]]] = ..., custom_fields: _Optional[_Mapping[str, CustomFieldValue]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., owner: _Optional[_Union[Owner, _Mapping]] = ..., replicate_components: bool = ..., adopt_components: bool = ...) -> None: ...

class ModuleBay(_message.Message):
    __slots__ = ("device", "module", "name", "installed_module", "label", "position", "description", "tags", "custom_fields", "metadata", "owner", "enabled", "module_bay_types")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    OWNER_FIELD_NUMBER: _ClassVar[int]
    ENABLED_FIELD_NUMBER: _ClassVar[int]
    MODULE_BAY_TYPES_FIELD_NUMBER: _ClassVar[int]
    device: Device
    module: Module
    name: str
    ...
    owner: Owner
    enabled: bool
    module_bay_types: _containers.RepeatedCompositeFieldContainer[ModuleBayType]
    def __init__(self, device: _Optional[_Union[Device, _Mapping]] = ..., module: _Optional[_Union[Module, _Mapping]] = ..., name: _Optional[str] = ..., installed_module: _Optional[_Union[Module, _Mapping]] = ..., label: _Optional[str] = ..., position: _Optional[str] = ..., description: _Optional[str] = ..., tags: _Optional[_Iterable[_Union[Tag, _Mapping]]] = ..., custom_fields: _Optional[_Mapping[str, CustomFieldValue]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., owner: _Optional[_Union[Owner, _Mapping]] = ..., enabled: bool = ..., module_bay_types: _Optional[_Iterable[_Union[ModuleBayType, _Mapping]]] = ...) -> None: ...

class ModuleType(_message.Message):
    __slots__ = ("manufacturer", "model", "part_number", "airflow", "weight", "weight_unit", "description", "comments", "tags", "custom_fields", "profile", "attributes", "metadata", "owner", "cooling_method", "end_of_life", "module_bay_types")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class PowerFeed(_message.Message):
    __slots__ = ("power_panel", "rack", "name", "status", "type", "supply", "phase", "voltage", "amperage", "max_utilization", "mark_connected", "description", "tenant", "comments", "tags", "custom_fields", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class PowerOutlet(_message.Message):
    __slots__ = ("device", "module", "name", "label", "type", "color", "power_port", "feed_leg", "description", "mark_connected", "tags", "custom_fields", "status", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class PowerPanel(_message.Message):
    __slots__ = ("site", "location", "name", "description", "comments", "tags", "custom_fields", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class PowerPort(_message.Message):
    __slots__ = ("device", "module", "name", "label", "type", "maximum_draw", "allocated_draw", "description", "mark_connected", "tags", "custom_fields", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class Prefix(_message.Message):
    __slots__ = ("prefix", "vrf", "scope_location", "scope_region", "scope_site", "scope_site_group", "tenant", "vlan", "status", "role", "is_pool", "mark_utilized", "description", "comments", "tags", "custom_fields", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class Provider(_message.Message):
    __slots__ = ("name", "slug", "description", "comments", "tags", "custom_fields", "accounts", "asns", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class ProviderAccount(_message.Message):
    __slots__ = ("provider", "name", "account", "description", "comments", "tags", "custom_fields", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class ProviderNetwork(_message.Message):
    __slots__ = ("provider", "name", "service_id", "description", "comments", "tags", "custom_fields", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class RIR(_message.Message):
    __slots__ = ("name", "slug", "is_private", "description", "tags", "custom_fields", "metadata", "owner", "comments")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    owner: Owner
    comments: str
    def __init__(self, name: _Optional[str] = ..., slug: _Optional[str] = ..., is_private: bool = ..., description: _Optional[str] = ..., tags: _Optional[_Iterable[_Union[Tag, _Mapping]]] = ..., custom_fields: _Optional[_Mapping[str, CustomFieldValue]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., owner: _Optional[_Union[Owner, _Mapping]] = ..., comments: _Optional[str] = ...) -> None: ...

class Rack(_message.Message):
    __slots__ = ("name", "facility_id", "site", "location", "tenant", "status", "role", "serial", "asset_tag", "rack_type", "form_factor", "width", "u_height", "starting_unit", "weight", "max_weight", "weight_unit", "desc_units", "outer_width", "outer_depth", "outer_unit", "mounting_depth", "airflow", "description", "comments", "tags", "custom_fields", "outer_height", "metadata", "owner", "group", "cooling_capability", "cooling_capacity")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    OWNER_FIELD_NUMBER: _ClassVar[int]
    GROUP_FIELD_NUMBER: _ClassVar[int]
    COOLING_CAPABILITY_FIELD_NUMBER: _ClassVar[int]
    COOLING_CAPACITY_FIELD_NUMBER: _ClassVar[int]
    name: str
    facility_id: str
    site: Site
    location: Location
...
class RackReservation(_message.Message):
    ...
    owner: Owner
    user: User
    def __init__(self, rack: _Optional[_Union[Rack, _Mapping]] = ..., units: _Optional[_Iterable[int]] = ..., tenant: _Optional[_Union[Tenant, _Mapping]] = ..., description: _Optional[str] = ..., comments: _Optional[str] = ..., tags: _Optional[_Iterable[_Union[Tag, _Mapping]]] = ..., custom_fields: _Optional[_Mapping[str, CustomFieldValue]] = ..., status: _Optional[str] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., owner: _Optional[_Union[Owner, _Mapping]] = ..., user: _Optional[_Union[User, _Mapping]] = ...) -> None: ...
...
class RackType(_message.Message):
    __slots__ = ("manufacturer", "model", "slug", "description", "form_factor", "width", "u_height", "starting_unit", "desc_units", "outer_width", "outer_depth", "outer_unit", "weight", "max_weight", "weight_unit", "mounting_depth", "comments", "tags", "custom_fields", "outer_height", "metadata", "owner", "cooling_capability", "cooling_capacity")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class Role(_message.Message):
    __slots__ = ("name", "slug", "weight", "description", "tags", "custom_fields", "metadata", "owner", "comments")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    owner: Owner
    comments: str
    def __init__(self, name: _Optional[str] = ..., slug: _Optional[str] = ..., weight: _Optional[int] = ..., description: _Optional[str] = ..., tags: _Optional[_Iterable[_Union[Tag, _Mapping]]] = ..., custom_fields: _Optional[_Mapping[str, CustomFieldValue]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., owner: _Optional[_Union[Owner, _Mapping]] = ..., comments: _Optional[str] = ...) -> None: ...

class RouteTarget(_message.Message):
    __slots__ = ("name", "tenant", "description", "comments", "tags", "custom_fields", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class Service(_message.Message):
    __slots__ = ("device", "virtual_machine", "name", "protocol", "ports", "description", "comments", "tags", "custom_fields", "ipaddresses", "parent_object_device", "parent_object_fhrp_group", "parent_object_virtual_machine", "metadata", "owner", "port_mappings")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class Tag(_message.Message):
    __slots__ = ("name", "slug", "color", "description", "weight", "object_types", "metadata")
    NAME_FIELD_NUMBER: _ClassVar[int]
    SLUG_FIELD_NUMBER: _ClassVar[int]
    COLOR_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    ...
    metadata: _struct_pb2.Struct
    def __init__(self, name: _Optional[str] = ..., slug: _Optional[str] = ..., color: _Optional[str] = ..., description: _Optional[str] = ..., weight: _Optional[int] = ..., object_types: _Optional[_Iterable[str]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...

class Tenant(_message.Message):
    __slots__ = ("name", "slug", "group", "description", "comments", "tags", "custom_fields", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class Tunnel(_message.Message):
    __slots__ = ("name", "status", "group", "encapsulation", "ipsec_profile", "tenant", "tunnel_id", "description", "comments", "tags", "custom_fields", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class TunnelTermination(_message.Message):
    ...
    TERMINATION_OWNER_FIELD_NUMBER: _ClassVar[int]
    TERMINATION_OWNER_GROUP_FIELD_NUMBER: _ClassVar[int]
    TERMINATION_CABLE_BUNDLE_FIELD_NUMBER: _ClassVar[int]
    TERMINATION_RACK_GROUP_FIELD_NUMBER: _ClassVar[int]
    TERMINATION_SCRIPT_MODULE_FIELD_NUMBER: _ClassVar[int]
    TERMINATION_VIRTUAL_MACHINE_TYPE_FIELD_NUMBER: _ClassVar[int]
    TERMINATION_USER_FIELD_NUMBER: _ClassVar[int]
    TERMINATION_COOLING_FEED_FIELD_NUMBER: _ClassVar[int]
    TERMINATION_COOLING_INTAKE_FIELD_NUMBER: _ClassVar[int]
    TERMINATION_COOLING_OUTFLOW_FIELD_NUMBER: _ClassVar[int]
    TERMINATION_COOLING_SOURCE_FIELD_NUMBER: _ClassVar[int]
    TERMINATION_MODULE_BAY_TYPE_FIELD_NUMBER: _ClassVar[int]
...
class VLANGroup(_message.Message):
    __slots__ = ("name", "slug", "scope_cluster", "scope_cluster_group", "scope_location", "scope_rack", "scope_region", "scope_site", "scope_site_group", "scope_rack_group", "vid_ranges", "description", "tags", "custom_fields", "tenant", "metadata", "owner", "comments")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    SCOPE_SITE_FIELD_NUMBER: _ClassVar[int]
    SCOPE_SITE_GROUP_FIELD_NUMBER: _ClassVar[int]
    SCOPE_RACK_GROUP_FIELD_NUMBER: _ClassVar[int]
...
class VLANTranslationPolicy(_message.Message):
    ...
    owner: Owner
    comments: str
    def __init__(self, name: _Optional[str] = ..., description: _Optional[str] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., owner: _Optional[_Union[Owner, _Mapping]] = ..., comments: _Optional[str] = ...) -> None: ...

class VLANTranslationRule(_message.Message):
    __slots__ = ("policy", "local_vid", "remote_vid", "description", "metadata")
    ...
    description: str
    metadata: _struct_pb2.Struct
    def __init__(self, policy: _Optional[_Union[VLANTranslationPolicy, _Mapping]] = ..., local_vid: _Optional[int] = ..., remote_vid: _Optional[int] = ..., description: _Optional[str] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...

class VMInterface(_message.Message):
    __slots__ = ("virtual_machine", "name", "enabled", "parent", "bridge", "mtu", "primary_mac_address", "description", "mode", "untagged_vlan", "qinq_svlan", "vlan_translation_policy", "vrf", "tags", "custom_fields", "tagged_vlans", "metadata", "owner", "mac_address")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class VirtualChassis(_message.Message):
    __slots__ = ("name", "domain", "master", "description", "comments", "tags", "custom_fields", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class VirtualCircuit(_message.Message):
    __slots__ = ("cid", "provider_network", "provider_account", "type", "status", "tenant", "description", "comments", "tags", "custom_fields", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class VirtualCircuitTermination(_message.Message):
    __slots__ = ("virtual_circuit", "role", "interface", "description", "tags", "custom_fields", "metadata")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    custom_fields: _containers.MessageMap[str, CustomFieldValue]
    metadata: _struct_pb2.Struct
    def __init__(self, virtual_circuit: _Optional[_Union[VirtualCircuit, _Mapping]] = ..., role: _Optional[str] = ..., interface: _Optional[_Union[Interface, _Mapping]] = ..., description: _Optional[str] = ..., tags: _Optional[_Iterable[_Union[Tag, _Mapping]]] = ..., custom_fields: _Optional[_Mapping[str, CustomFieldValue]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...
...
class VirtualDeviceContext(_message.Message):
    __slots__ = ("name", "device", "identifier", "tenant", "primary_ip4", "primary_ip6", "status", "description", "comments", "tags", "custom_fields", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class VirtualDisk(_message.Message):
    __slots__ = ("virtual_machine", "name", "description", "size", "tags", "custom_fields", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class VirtualMachine(_message.Message):
    __slots__ = ("name", "status", "site", "cluster", "device", "serial", "role", "tenant", "platform", "primary_ip4", "primary_ip6", "vcpus", "memory", "disk", "description", "comments", "tags", "custom_fields", "metadata", "start_on_boot", "owner", "virtual_machine_type")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    CUSTOM_FIELDS_FIELD_NUMBER: _ClassVar[int]
    METADATA_FIELD_NUMBER: _ClassVar[int]
    START_ON_BOOT_FIELD_NUMBER: _ClassVar[int]
    OWNER_FIELD_NUMBER: _ClassVar[int]
    VIRTUAL_MACHINE_TYPE_FIELD_NUMBER: _ClassVar[int]
    name: str
    status: str
...
class WirelessLink(_message.Message):
    __slots__ = ("interface_a", "interface_b", "ssid", "status", "tenant", "auth_type", "auth_cipher", "auth_psk", "distance", "distance_unit", "description", "comments", "tags", "custom_fields", "metadata", "owner")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class CustomField(_message.Message):
    ...
    METADATA_FIELD_NUMBER: _ClassVar[int]
    OWNER_FIELD_NUMBER: _ClassVar[int]
    VALIDATION_SCHEMA_FIELD_NUMBER: _ClassVar[int]
...
class CustomFieldChoiceSet(_message.Message):
    ...
    METADATA_FIELD_NUMBER: _ClassVar[int]
    OWNER_FIELD_NUMBER: _ClassVar[int]
    CHOICE_COLORS_FIELD_NUMBER: _ClassVar[int]
    name: str
    description: str
    base_choices: str
    ...
    owner: Owner
    choice_colors: str
    def __init__(self, name: _Optional[str] = ..., description: _Optional[str] = ..., base_choices: _Optional[str] = ..., order_alphabetically: bool = ..., extra_choices: _Optional[_Iterable[str]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., owner: _Optional[_Union[Owner, _Mapping]] = ..., choice_colors: _Optional[str] = ...) -> None: ...

class JournalEntry(_message.Message):
    __slots__ = ("assigned_object_asn", "assigned_object_asn_range", "assigned_object_aggregate", "assigned_object_cable", "assigned_object_cable_path", "assigned_object_cable_termination", "assigned_object_circuit", "assigned_object_circuit_group", "assigned_object_circuit_group_assignment", "assigned_object_circuit_termination", "assigned_object_circuit_type", "assigned_object_cluster", "assigned_object_cluster_group", "assigned_object_cluster_type", "assigned_object_console_port", "assigned_object_console_server_port", "assigned_object_contact", "assigned_object_contact_assignment", "assigned_object_contact_group", "assigned_object_contact_role", "assigned_object_custom_field", "assigned_object_custom_field_choice_set", "assigned_object_device", "assigned_object_device_bay", "assigned_object_device_role", "assigned_object_device_type", "assigned_object_fhrp_group", "assigned_object_fhrp_group_assignment", "assigned_object_front_port", "assigned_object_ike_policy", "assigned_object_ike_proposal", "assigned_object_ip_address", "assigned_object_ip_range", "assigned_object_ip_sec_policy", "assigned_object_ip_sec_profile", "assigned_object_ip_sec_proposal", "assigned_object_interface", "assigned_object_inventory_item", "assigned_object_inventory_item_role", "assigned_object_journal_entry", "assigned_object_l2vpn", "assigned_object_l2vpn_termination", "assigned_object_location", "assigned_object_mac_address", "assigned_object_manufacturer", "assigned_object_module", "assigned_object_module_bay", "assigned_object_module_type", "assigned_object_module_type_profile", "assigned_object_platform", "assigned_object_power_feed", "assigned_object_power_outlet", "assigned_object_power_panel", "assigned_object_power_port", "assigned_object_prefix", "assigned_object_provider", "assigned_object_provider_account", "assigned_object_provider_network", "assigned_object_rir", "assigned_object_rack", "assigned_object_rack_reservation", "assigned_object_rack_role", "assigned_object_rack_type", "assigned_object_rear_port", "assigned_object_region", "assigned_object_role", "assigned_object_route_target", "assigned_object_service", "assigned_object_site", "assigned_object_site_group", "assigned_object_tag", "assigned_object_tenant", "assigned_object_tenant_group", "assigned_object_tunnel", "assigned_object_tunnel_group", "assigned_object_tunnel_termination", "assigned_object_vlan", "assigned_object_vlan_group", "assigned_object_vlan_translation_policy", "assigned_object_vlan_translation_rule", "assigned_object_vm_interface", "assigned_object_vrf", "assigned_object_virtual_chassis", "assigned_object_virtual_circuit", "assigned_object_virtual_circuit_termination", "assigned_object_virtual_circuit_type", "assigned_object_virtual_device_context", "assigned_object_virtual_disk", "assigned_object_virtual_machine", "assigned_object_wireless_lan", "assigned_object_wireless_lan_group", "assigned_object_wireless_link", "assigned_object_custom_link", "assigned_object_owner", "assigned_object_owner_group", "assigned_object_cable_bundle", "assigned_object_rack_group", "assigned_object_script_module", "assigned_object_virtual_machine_type", "assigned_object_user", "assigned_object_cooling_feed", "assigned_object_cooling_intake", "assigned_object_cooling_outflow", "assigned_object_cooling_source", "assigned_object_module_bay_type", "kind", "comments", "tags", "custom_fields", "metadata", "created_by")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class CustomLink(_message.Message):
    __slots__ = ("name", "enabled", "link_text", "link_url", "weight", "group_name", "button_class", "new_window", "object_types", "metadata", "owner")
    NAME_FIELD_NUMBER: _ClassVar[int]
    ENABLED_FIELD_NUMBER: _ClassVar[int]
...
class Owner(_message.Message):
    __slots__ = ("name", "group", "description", "metadata", "users")
    NAME_FIELD_NUMBER: _ClassVar[int]
    GROUP_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    METADATA_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, name: _Optional[str] = ..., group: _Optional[_Union[OwnerGroup, _Mapping]] = ..., description: _Optional[str] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., users: _Optional[_Iterable[_Union[User, _Mapping]]] = ...) -> None: ...

class OwnerGroup(_message.Message):
    ...
    description: str
    metadata: _struct_pb2.Struct
    def __init__(self, name: _Optional[str] = ..., description: _Optional[str] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...

class DeviceConfig(_message.Message):
    __slots__ = ("startup", "running", "candidate", "metadata")
    ...
    candidate: bytes
    metadata: _struct_pb2.Struct
    def __init__(self, startup: _Optional[bytes] = ..., running: _Optional[bytes] = ..., candidate: _Optional[bytes] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...

class CableBundle(_message.Message):
    __slots__ = ("name", "description", "owner", "comments", "tags", "custom_fields", "metadata")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    custom_fields: _containers.MessageMap[str, CustomFieldValue]
    metadata: _struct_pb2.Struct
    def __init__(self, name: _Optional[str] = ..., description: _Optional[str] = ..., owner: _Optional[_Union[Owner, _Mapping]] = ..., comments: _Optional[str] = ..., tags: _Optional[_Iterable[_Union[Tag, _Mapping]]] = ..., custom_fields: _Optional[_Mapping[str, CustomFieldValue]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...

class RackGroup(_message.Message):
    __slots__ = ("name", "slug", "description", "owner", "comments", "tags", "custom_fields", "metadata")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    custom_fields: _containers.MessageMap[str, CustomFieldValue]
    metadata: _struct_pb2.Struct
    def __init__(self, name: _Optional[str] = ..., slug: _Optional[str] = ..., description: _Optional[str] = ..., owner: _Optional[_Union[Owner, _Mapping]] = ..., comments: _Optional[str] = ..., tags: _Optional[_Iterable[_Union[Tag, _Mapping]]] = ..., custom_fields: _Optional[_Mapping[str, CustomFieldValue]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...

class ScriptModule(_message.Message):
    __slots__ = ("file", "metadata")
    FILE_FIELD_NUMBER: _ClassVar[int]
    METADATA_FIELD_NUMBER: _ClassVar[int]
    file: str
    metadata: _struct_pb2.Struct
    def __init__(self, file: _Optional[str] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...

class VirtualMachineType(_message.Message):
    __slots__ = ("name", "slug", "default_platform", "default_vcpus", "default_memory", "description", "owner", "comments", "tags", "custom_fields", "metadata")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    SLUG_FIELD_NUMBER: _ClassVar[int]
    DEFAULT_PLATFORM_FIELD_NUMBER: _ClassVar[int]
    DEFAULT_VCPUS_FIELD_NUMBER: _ClassVar[int]
    DEFAULT_MEMORY_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    OWNER_FIELD_NUMBER: _ClassVar[int]
    COMMENTS_FIELD_NUMBER: _ClassVar[int]
    TAGS_FIELD_NUMBER: _ClassVar[int]
    ...
    custom_fields: _containers.MessageMap[str, CustomFieldValue]
    metadata: _struct_pb2.Struct
    def __init__(self, name: _Optional[str] = ..., slug: _Optional[str] = ..., default_platform: _Optional[_Union[Platform, _Mapping]] = ..., default_vcpus: _Optional[float] = ..., default_memory: _Optional[int] = ..., description: _Optional[str] = ..., owner: _Optional[_Union[Owner, _Mapping]] = ..., comments: _Optional[str] = ..., tags: _Optional[_Iterable[_Union[Tag, _Mapping]]] = ..., custom_fields: _Optional[_Mapping[str, CustomFieldValue]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...

class User(_message.Message):
    __slots__ = ("username", "metadata")
    USERNAME_FIELD_NUMBER: _ClassVar[int]
    METADATA_FIELD_NUMBER: _ClassVar[int]
    username: str
    metadata: _struct_pb2.Struct
    def __init__(self, username: _Optional[str] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...

class CoolingFeed(_message.Message):
    __slots__ = ("cooling_source", "rack", "name", "status", "cooling_capacity", "max_flow", "max_flow_unit", "description", "tenant", "owner", "comments", "tags", "custom_fields", "metadata")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    STATUS_FIELD_NUMBER: _ClassVar[int]
    COOLING_CAPACITY_FIELD_NUMBER: _ClassVar[int]
    MAX_FLOW_FIELD_NUMBER: _ClassVar[int]
    MAX_FLOW_UNIT_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    TENANT_FIELD_NUMBER: _ClassVar[int]
    OWNER_FIELD_NUMBER: _ClassVar[int]
    COMMENTS_FIELD_NUMBER: _ClassVar[int]
    ...
    custom_fields: _containers.MessageMap[str, CustomFieldValue]
    metadata: _struct_pb2.Struct
    def __init__(self, cooling_source: _Optional[_Union[CoolingSource, _Mapping]] = ..., rack: _Optional[_Union[Rack, _Mapping]] = ..., name: _Optional[str] = ..., status: _Optional[str] = ..., cooling_capacity: _Optional[float] = ..., max_flow: _Optional[float] = ..., max_flow_unit: _Optional[str] = ..., description: _Optional[str] = ..., tenant: _Optional[_Union[Tenant, _Mapping]] = ..., owner: _Optional[_Union[Owner, _Mapping]] = ..., comments: _Optional[str] = ..., tags: _Optional[_Iterable[_Union[Tag, _Mapping]]] = ..., custom_fields: _Optional[_Mapping[str, CustomFieldValue]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...

class CoolingIntake(_message.Message):
    __slots__ = ("device", "module", "name", "label", "type", "diameter", "diameter_unit", "max_flow", "max_flow_unit", "cooling_outflow", "description", "owner", "tags", "custom_fields", "metadata")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    DIAMETER_UNIT_FIELD_NUMBER: _ClassVar[int]
    MAX_FLOW_FIELD_NUMBER: _ClassVar[int]
    MAX_FLOW_UNIT_FIELD_NUMBER: _ClassVar[int]
    COOLING_OUTFLOW_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    ...
    custom_fields: _containers.MessageMap[str, CustomFieldValue]
    metadata: _struct_pb2.Struct
    def __init__(self, device: _Optional[_Union[Device, _Mapping]] = ..., module: _Optional[_Union[Module, _Mapping]] = ..., name: _Optional[str] = ..., label: _Optional[str] = ..., type: _Optional[str] = ..., diameter: _Optional[float] = ..., diameter_unit: _Optional[str] = ..., max_flow: _Optional[float] = ..., max_flow_unit: _Optional[str] = ..., cooling_outflow: _Optional[_Union[CoolingOutflow, _Mapping]] = ..., description: _Optional[str] = ..., owner: _Optional[_Union[Owner, _Mapping]] = ..., tags: _Optional[_Iterable[_Union[Tag, _Mapping]]] = ..., custom_fields: _Optional[_Mapping[str, CustomFieldValue]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...

class CoolingOutflow(_message.Message):
    __slots__ = ("device", "module", "name", "label", "type", "diameter", "diameter_unit", "cooling_intake", "description", "owner", "tags", "custom_fields", "metadata")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    custom_fields: _containers.MessageMap[str, CustomFieldValue]
    metadata: _struct_pb2.Struct
    def __init__(self, device: _Optional[_Union[Device, _Mapping]] = ..., module: _Optional[_Union[Module, _Mapping]] = ..., name: _Optional[str] = ..., label: _Optional[str] = ..., type: _Optional[str] = ..., diameter: _Optional[float] = ..., diameter_unit: _Optional[str] = ..., cooling_intake: _Optional[_Union[CoolingIntake, _Mapping]] = ..., description: _Optional[str] = ..., owner: _Optional[_Union[Owner, _Mapping]] = ..., tags: _Optional[_Iterable[_Union[Tag, _Mapping]]] = ..., custom_fields: _Optional[_Mapping[str, CustomFieldValue]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...

class CoolingSource(_message.Message):
    __slots__ = ("site", "location", "name", "type", "status", "fluid_type", "cooling_capacity", "description", "owner", "comments", "tags", "custom_fields", "metadata")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    TYPE_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
    FLUID_TYPE_FIELD_NUMBER: _ClassVar[int]
    COOLING_CAPACITY_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    OWNER_FIELD_NUMBER: _ClassVar[int]
    COMMENTS_FIELD_NUMBER: _ClassVar[int]
    ...
    custom_fields: _containers.MessageMap[str, CustomFieldValue]
    metadata: _struct_pb2.Struct
    def __init__(self, site: _Optional[_Union[Site, _Mapping]] = ..., location: _Optional[_Union[Location, _Mapping]] = ..., name: _Optional[str] = ..., type: _Optional[str] = ..., status: _Optional[str] = ..., fluid_type: _Optional[str] = ..., cooling_capacity: _Optional[float] = ..., description: _Optional[str] = ..., owner: _Optional[_Union[Owner, _Mapping]] = ..., comments: _Optional[str] = ..., tags: _Optional[_Iterable[_Union[Tag, _Mapping]]] = ..., custom_fields: _Optional[_Mapping[str, CustomFieldValue]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...

class ModuleBayType(_message.Message):
    __slots__ = ("name", "slug", "manufacturer", "color", "description", "owner", "comments", "tags", "custom_fields", "metadata")
    class CustomFieldsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    custom_fields: _containers.MessageMap[str, CustomFieldValue]
    metadata: _struct_pb2.Struct
    def __init__(self, name: _Optional[str] = ..., slug: _Optional[str] = ..., manufacturer: _Optional[_Union[Manufacturer, _Mapping]] = ..., color: _Optional[str] = ..., description: _Optional[str] = ..., owner: _Optional[_Union[Owner, _Mapping]] = ..., comments: _Optional[str] = ..., tags: _Optional[_Iterable[_Union[Tag, _Mapping]]] = ..., custom_fields: _Optional[_Mapping[str, CustomFieldValue]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...
