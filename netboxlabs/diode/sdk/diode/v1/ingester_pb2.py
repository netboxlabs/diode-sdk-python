...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'Z3github.com/netboxlabs/diode-sdk-go/diode/v1/diodepb'
  ...
  _globals['_CLUSTER'].fields_by_name['name']._serialized_options = b'\372B\006r\004\020\001\030d'
  _globals['_CLUSTER'].fields_by_name['status']._loaded_options = None
  _globals['_CLUSTER'].fields_by_name['status']._serialized_options = b'\372B=r;R\007offlineR\006activeR\007plannedR\006stagedR\006failedR\017decommissioning'
  _globals['_CLUSTER'].fields_by_name['description']._loaded_options = None
  _globals['_CLUSTER'].fields_by_name['description']._serialized_options = b'\372B\005r\003\030\310\001'
  _globals['_CLUSTERTYPE'].fields_by_name['name']._loaded_options = None
  _globals['_CLUSTERTYPE'].fields_by_name['name']._serialized_options = b'\372B\006r\004\020\001\030d'
  _globals['_CLUSTERTYPE'].fields_by_name['slug']._loaded_options = None
  _globals['_CLUSTERTYPE'].fields_by_name['slug']._serialized_options = b'\372B\030r\026\020\001\030d2\020^[-a-zA-Z0-9_]+$'
  _globals['_CLUSTERTYPE'].fields_by_name['description']._loaded_options = None
  _globals['_CLUSTERTYPE'].fields_by_name['description']._serialized_options = b'\372B\005r\003\030\310\001'
  _globals['_CLUSTERGROUP'].fields_by_name['name']._loaded_options = None
  _globals['_CLUSTERGROUP'].fields_by_name['name']._serialized_options = b'\372B\006r\004\020\001\030d'
  _globals['_CLUSTERGROUP'].fields_by_name['slug']._loaded_options = None
  _globals['_CLUSTERGROUP'].fields_by_name['slug']._serialized_options = b'\372B\030r\026\020\001\030d2\020^[-a-zA-Z0-9_]+$'
  _globals['_CLUSTERGROUP'].fields_by_name['description']._loaded_options = None
  _globals['_CLUSTERGROUP'].fields_by_name['description']._serialized_options = b'\372B\005r\003\030\310\001'
  _globals['_VIRTUALMACHINE'].fields_by_name['name']._loaded_options = None
  _globals['_VIRTUALMACHINE'].fields_by_name['name']._serialized_options = b'\372B\004r\002\030@'
  _globals['_VIRTUALMACHINE'].fields_by_name['status']._loaded_options = None
  _globals['_VIRTUALMACHINE'].fields_by_name['status']._serialized_options = b'\372B=r;R\007offlineR\006activeR\007plannedR\006stagedR\006failedR\017decommissioning'
  _globals['_VIRTUALMACHINE'].fields_by_name['vcpus']._loaded_options = None
  _globals['_VIRTUALMACHINE'].fields_by_name['vcpus']._serialized_options = b'\372B\004\032\002(\000'
  _globals['_VIRTUALMACHINE'].fields_by_name['memory']._loaded_options = None
  _globals['_VIRTUALMACHINE'].fields_by_name['memory']._serialized_options = b'\372B\004\032\002(\000'
  _globals['_VIRTUALMACHINE'].fields_by_name['disk']._loaded_options = None
  _globals['_VIRTUALMACHINE'].fields_by_name['disk']._serialized_options = b'\372B\004\032\002(\000'
  _globals['_VIRTUALMACHINE'].fields_by_name['description']._loaded_options = None
  _globals['_VIRTUALMACHINE'].fields_by_name['description']._serialized_options = b'\372B\005r\003\030\310\001'
  _globals['_VIRTUALINTERFACE'].fields_by_name['virtual_machine']._loaded_options = None
  _globals['_VIRTUALINTERFACE'].fields_by_name['virtual_machine']._serialized_options = b'\372B\005\242\001\002\010\001'
  _globals['_VIRTUALINTERFACE'].fields_by_name['name']._loaded_options = None
  _globals['_VIRTUALINTERFACE'].fields_by_name['name']._serialized_options = b'\372B\006r\004\020\001\030@'
  _globals['_VIRTUALINTERFACE'].fields_by_name['mtu']._loaded_options = None
  _globals['_VIRTUALINTERFACE'].fields_by_name['mtu']._serialized_options = b'\372B\010\032\006\030\200\200\004(\001'
  _globals['_VIRTUALINTERFACE'].fields_by_name['description']._loaded_options = None
  _globals['_VIRTUALINTERFACE'].fields_by_name['description']._serialized_options = b'\372B\005r\003\030\310\001'
  _globals['_VIRTUALDISK'].fields_by_name['virtual_machine']._loaded_options = None
  _globals['_VIRTUALDISK'].fields_by_name['virtual_machine']._serialized_options = b'\372B\005\242\001\002\010\001'
  _globals['_VIRTUALDISK'].fields_by_name['name']._loaded_options = None
  _globals['_VIRTUALDISK'].fields_by_name['name']._serialized_options = b'\372B\006r\004\020\001\030d'
  _globals['_VIRTUALDISK'].fields_by_name['size']._loaded_options = None
  _globals['_VIRTUALDISK'].fields_by_name['size']._serialized_options = b'\372B\004\032\002(\000'
  _globals['_VIRTUALDISK'].fields_by_name['description']._loaded_options = None
  _globals['_VIRTUALDISK'].fields_by_name['description']._serialized_options = b'\372B\005r\003\030\310\001'
  ...
  _globals['_DEVICE']._serialized_end=836
  _globals['_INTERFACE']._serialized_start=839
  _globals['_INTERFACE']._serialized_end=3126
  _globals['_CLUSTER']._serialized_start=3129
  _globals['_CLUSTER']._serialized_end=3484
  _globals['_CLUSTERTYPE']._serialized_start=3487
  _globals['_CLUSTERTYPE']._serialized_end=3680
  _globals['_CLUSTERGROUP']._serialized_start=3683
  _globals['_CLUSTERGROUP']._serialized_end=3877
  _globals['_VIRTUALMACHINE']._serialized_start=3880
  _globals['_VIRTUALMACHINE']._serialized_end=4614
  _globals['_VIRTUALINTERFACE']._serialized_start=4617
  _globals['_VIRTUALINTERFACE']._serialized_end=4984
  _globals['_VIRTUALDISK']._serialized_start=4987
  _globals['_VIRTUALDISK']._serialized_end=5237
  _globals['_IPADDRESS']._serialized_start=5240
  _globals['_IPADDRESS']._serialized_end=5764
  _globals['_DEVICETYPE']._serialized_start=5767
  _globals['_DEVICETYPE']._serialized_end=6130
  _globals['_MANUFACTURER']._serialized_start=6133
  _globals['_MANUFACTURER']._serialized_end=6327
  _globals['_PLATFORM']._serialized_start=6330
  _globals['_PLATFORM']._serialized_end=6580
  _globals['_PREFIX']._serialized_start=6583
  _globals['_PREFIX']._serialized_end=6980
  _globals['_ROLE']._serialized_start=6983
  _globals['_ROLE']._serialized_end=7217
  _globals['_SITE']._serialized_start=7220
  _globals['_SITE']._serialized_end=7638
  _globals['_TAG']._serialized_start=7641
  _globals['_TAG']._serialized_end=7774
  _globals['_ENTITY']._serialized_start=7777
  _globals['_ENTITY']._serialized_end=8692
  _globals['_INGESTREQUEST']._serialized_start=8695
  _globals['_INGESTREQUEST']._serialized_end=9051
  _globals['_INGESTRESPONSE']._serialized_start=9053
  _globals['_INGESTRESPONSE']._serialized_end=9093
  _globals['_INGESTERSERVICE']._serialized_start=9095
  _globals['_INGESTERSERVICE']._serialized_end=9175
